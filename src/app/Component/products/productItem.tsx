...
const ProductItem22 = ({ product }: ProductItemProps) => {
  const productUrl = `/product/${product._id}`;

  return (
    <Link href={productUrl} className='block'>
      <div className='bg-white rounded-lg overflow-hidden relative hover:shadow-xl transition-shadow'>
        ...
        <div className='p-4 text-black'>
          ...
          <div className='flex flex-col'>
            ...
            {/* Optional: Keep the button inside if you want more emphasis */}
            <div className='w-full text-center bg-gradient-to-r from-red-500 to-orange-500 text-white py-2 rounded-full text-sm font-bold hover:brightness-110 transition-all'>
              GRAB IT NOW!
            </div>
